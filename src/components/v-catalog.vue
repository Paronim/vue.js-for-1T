<template>
    ...
    <div class="v-catalog">
        ...
        <vCatalogItem v-for="product in products" :key="product.article" :product_data="product" @sendDataToCatalog="showArticleFromCatalogItem"/>
    </div>
  </template>
...
export default {
  ...
  methods: {
    showArticleFromCatalogItem (data) {
      console.log(data)
    }
  }
}
